...
_REFERENCES_DIR = _Path(__file__).resolve().parent.parent / "openclaw" / "shared" / "references"
SCOUT_SYSTEM_PROMPT = (_REFERENCES_DIR / "company-scout-prompt.md").read_text().strip()
